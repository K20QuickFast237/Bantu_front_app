      ...
      <section className="bg-white sm:pt-18 sm:pb-6 px-4 sm:px-6 lg:px-8 flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 lg:gap-8 max-w-7xl w-full">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 flex flex-col justify-between items-center text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">{t('pricing.plans.basic.title')}</h3>
            ...
            <ul className="text-left text-gray-700 space-y-3 mb-10 w-full px-4">
              <li className="flex items-center">
                ...
                {t('pricing.plans.basic.features.connections')}
              </li>
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
                {t('pricing.plans.basic.features.profile')}
              </li>
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
          ...
          <div className="relative bg-white rounded-2xl shadow-xl border border-blue-500 p-8 flex flex-col justify-between items-center text-center transform scale-105">
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">{t('pricing.plans.pro.title')}</h3>
            <p className="text-4xl font-extrabold text-gray-900 mb-1">
              {t('pricing.plans.pro.price')}
              <span className="text-base font-medium text-gray-500">{t('pricing.plans.pro.month')}</span>
            </p>
            <p className="text-sm text-gray-500 mb-8 max-w-xs">
            ...
            <ul className="text-left text-gray-700 space-y-3 mb-10 w-full px-4">
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
                {t('pricing.plans.pro.features.connections')}
              </li>
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
                {t('pricing.plans.pro.features.profile')}
              </li>
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
                {t('pricing.plans.pro.features.matching')}
              </li>
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
          ...
          {/* Carte Entreprise */}
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-8 flex flex-col justify-between items-center text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-2">{t('pricing.plans.enterprise.title')}</h3>
            ...
            <ul className="text-left text-gray-700 space-y-3 mb-10 w-full px-4">
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
                {t('pricing.plans.enterprise.features.allIncluded')}
              </li>
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
                {t('pricing.plans.enterprise.features.team')}
              </li>
              <li className="flex items-center">
                <Check className="text-green-500 w-5 h-5 mr-2 flex-shrink-0" />
