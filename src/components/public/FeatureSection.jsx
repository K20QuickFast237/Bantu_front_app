        ...
        <div className='flex flex-col sm:flex-row mx-4 sm:mx-11 w-full mb-12 sm:mb-20'>
          ...
          <div className='w-full sm:w-1/5'>
            <div className="flex flex-col items-start text-left">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-gray-900">Recherche Simplifiée</h4>
          ...
          <div className='w-full sm:w-1/4 sm:ml-5 mt-6 sm:mt-0'>
            <div className="flex flex-col items-start text-left">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-gray-900">Réseautage & Certifications</h4>
              <p className="text-gray-600 text-sm font-light">
          ...
          <div className='w-full sm:w-1/5 sm:ml-5 mt-6 sm:mt-0'>
            <div className="flex flex-col items-start text-left">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-gray-900">Messagerie Directe</h4>
              <p className="text-gray-600 text-sm font-light">
        ...
        <div className='flex flex-col sm:flex-row mx-4 sm:mx-11 w-full mt-[-10px]'>
          ...
          <div className='w-full sm:w-1/5'>
            <div className="flex flex-col items-start text-left">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-gray-900">Boutique Personnalisée</h4>
              <p className="text-gray-600 text-sm font-light">
          ...
          <div className='w-full sm:w-1/4 sm:ml-5 mt-6 sm:mt-0'>
            <div className="flex flex-col items-start text-left">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-gray-900">Paiement Sécurisé</h4>
              <p className="text-gray-600 text-sm font-light">
          ...
          <div className='w-full sm:w-1/5 sm:ml-5 mt-6 sm:mt-0'>
            <div className="flex flex-col items-start text-left">
              ...
              <h4 className="text-base sm:text-lg font-bold mb-2 text-gray-900">Chat Avec Clients</h4>
              <p className="text-gray-600 text-sm font-light">
