      ...
      <div className="bg-white rounded-3xl border border-gray-100 shadow-lg
       p-8 sm:py-12 md:p-16 w-full max-w-5xl text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mb-10">
          ...
          >
            <MessageSquare className="w-5 h-5 mr-2" /> {t('help.contact.liveChat')}
          </button>
          ...
          >
            <Mail className="w-5 h-5 mr-2" /> {t('help.contact.emailSupport')}
          </button>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-center items-start gap-8 md:gap-12">
          <InfoBlock 
            ...
            iconColor="#4A90E2"
            title={t('help.contact.quickResponse')} 
            description={t('help.contact.quickResponseDesc')} 
          />
          <InfoBlock 
            icon={CheckCircle}
            iconBgColor="rgba(255, 236, 179, 0.3)"
            iconColor="#F5A623"
            title={t('help.contact.expertSupport')} 
            description={t('help.contact.expertSupportDesc')} 
          />
          <InfoBlock 
            icon={Zap}
            iconBgColor="rgba(215, 255, 215, 0.3)"
            iconColor="#7ED321"
            title={t('help.contact.available247')} 
            description={t('help.contact.available247Desc')} 
          />
        </div>
      </div>
    </section>
