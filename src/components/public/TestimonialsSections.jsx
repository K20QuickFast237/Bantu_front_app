  ...
  const testimonials = [
    {
      ...
      name: t('aide.testimonials.sarah.name'),
      role: t('aide.testimonials.sarah.role'),
      reviewText: t('aide.testimonials.sarah.review'),
    },
    {
      initials: 'MC',
      initialBgColor: '#F5A623', 
      name: t('aide.testimonials.michael.name'),
      role: t('aide.testimonials.michael.role'),
      reviewText: t('aide.testimonials.michael.review'),
    },
    {
      initials: 'AO',
      initialBgColor: '#7ED321', 
      name: t('aide.testimonials.amara.name'),
      role: t('aide.testimonials.amara.role'),
      reviewText: t('aide.testimonials.amara.review'),
    },
  ];
