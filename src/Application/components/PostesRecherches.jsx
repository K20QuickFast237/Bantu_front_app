  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md max-w-[95%] mx-auto my-8 border border-gray-200">
      ...
      <div className="flex justify-between items-center mb-6 pb-4">
        <h2 className="text-xl font-semibold text-blue-800">Poste.s recherché.s</h2>
      ...
      <div className="space-y-6"> {/* Espacement vertical entre les groupes de critères */}
        ...
        <div className="flex items-start">
          <p className="w-56  text-sm mt-1">Les Métiers Les Plus Représentatifs De Votre Poste</p>
        ...
        {/* Lieux recherchés */}
        <div className="flex items-start">
          <p className="w-56  text-sm mt-1">Les Lieux Où Vous Recherchez Un Poste</p>
          <div className="flex flex-wrap gap-2 flex-grow">
            <span className="bg-emerald-100 text-emerald-800 text-sm px-3 py-1 rounded-md flex items-center">
        ...
        {/* Type de Contrat */}
        <div className="flex items-start">
          <p className="w-56 text-sm mt-1">Type De Contrat</p>
          <div className="flex flex-wrap gap-2 flex-grow">
            <span className="bg-emerald-100 text-emerald-800 text-sm px-3 py-1 rounded-md flex items-center">
        ...
        {/* Niveau D'expérience */}
        <div className="flex items-start">
          <p className="w-56  text-sm mt-1">Niveau D'expérience</p>
          <div className="flex flex-wrap gap-2 flex-grow">
            <span className="bg-emerald-100 text-emerald-800 text-sm px-3 py-1 rounded-md flex items-center">
