  ...
  return (
    <div className="w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col">
      ...
      <div className="p-6 border-b border-gray-200 text-center">
        ...
        <button className="mt-4 inline-flex items-center justify-center rounded-md font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none h-10 py-2 px-4 bg-yellow-500 text-white hover:bg-yellow-600 focus:ring-yellow-500 transform hover:scale-105 transition-all">
          Voir mon profil
        </button>
      </div>
